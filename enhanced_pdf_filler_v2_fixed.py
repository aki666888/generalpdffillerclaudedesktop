#!/usr/bin/env python3
"""
Enhanced PDF Filler V2 Fixed - Works with renamed symptoms field
"""
...
class EnhancedPDFFillerV2:
                    ...
                    if value:
                        for box in boxes:
                            if box['page'] == page_num:
                                ...
                                if field_type in ['Patient Symptoms and Signs', 'symptoms']:
    ...
    def _get_field_value(self, field_type, data):
        ...
        field_mappings = {
            ...
            'phn': 'phn',
            'phone': 'phone',
            'Patient Symptoms and Signs': 'symptoms',  # Old name
            'symptoms': 'symptoms',  # New name (if you renamed in JSON)
